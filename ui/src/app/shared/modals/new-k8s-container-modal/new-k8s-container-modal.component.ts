...
@Component({
  selector: 'app-new-k8s-container-modal',
  templateUrl: './new-k8s-container-modal.component.html',
  styleUrls: ['./new-k8s-container-modal.component.css']
})
export class NewK8sContainerModalComponent implements OnInit {
