...
export class K8sEmptyDirShape extends IconShape {

  public static TYPE = 'k8s-emptydir';

  volume: EmptyDirVolume;
  editorService: EditorService;

  constructor(editorService: EditorService, volume: EmptyDirVolume, attributes?: any, options?: any) {
    super('./assets/images/empty-dir.svg', volume.id, K8sEmptyDirShape.TYPE, attributes, options, true);
    this.volume = volume;
